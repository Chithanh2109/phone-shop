<?php
// ===== Khởi tạo và kiểm tra quyền truy cập admin =====
mb_internal_encoding('UTF-8'); // Thiết lập mã hóa nội bộ UTF-8
mb_http_output('UTF-8');
mb_regex_encoding('UTF-8');

require_once '../config/database.php'; // Kết nối CSDL
require_once '../includes/functions.php'; // Các hàm tiện ích
initSession(); // Khởi tạo session
...
function translateOrderStatus($status) {
    switch ($status) {
        ...
        default: return $status; // Giữ nguyên nếu không khớp
    }
}

// ===== Mảng trạng thái thanh toán tiếng Việt =====
...
<body>
    <div class="admin-wrapper">
        ...
        <!-- ===== Khu vực nội dung chính admin ===== -->
        <div class="admin-main-content">
            <!-- ===== Nội dung dashboard tổng quan ===== -->
